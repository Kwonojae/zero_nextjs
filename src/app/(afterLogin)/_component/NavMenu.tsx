...
export default function NavMenu() {
    //useSelectedLayoutSegments 는 밑에 자식 까지  전부 다나옴 
    //useSelectedLayoutSegment 첫 폴더까지만 나옴
    //useSelectedLayoutSegment : Client Component hook 으로서, Layout 내부의 라우트 세그먼트(세부부분,분할,쪼개논것)를 가져올 수 있다.
    const segment = useSelectedLayoutSegment(); //현재 레이아웃에 있는 
    console.log(segment) // 현재 레이아웃에 있는 가장 가까움 폴더들이 나옴 
    const me = {
        //임시로 내 정보 있는거처럼 
        id:'zero'
    }
